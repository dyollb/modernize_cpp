...
def main():
  ...
  parser.add_argument('-fix-errors', dest='fix_errors', action='store_true', help='apply fix-its')
  ...
  assert not (args.fix and args.fix_errors), "cannot choose -fix and -fix-errors"
